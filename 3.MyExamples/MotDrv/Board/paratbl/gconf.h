...
#define CONFIG_MODBUS_UART_PORT   huart1
#define CONFIG_MODBUS_RXDMA_PORT  hdma_usart1_rx
...
#define POS_LOOP_FREQ 1000  // unit: Hz
#define SPD_LOOP_FREQ 4000  // unit: Hz
#define CUR_LOOP_FREQ 8000  // unit: Hz
