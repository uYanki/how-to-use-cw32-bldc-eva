...
void I2C_init(void)
{
    ...
    I2C_SCL_GPIO_CLKEN(I2C_SCL_GPIO_CLK, ENABLE);
    I2C_SDA_GPIO_CLKEN(I2C_SDA_GPIO_CLK, ENABLE);
    I2C_CLKEN(I2C_CLK, ENABLE);

    PB06_AFx_I2C1SCL();
    PB07_AFx_I2C1SDA();

    GPIO_InitStructure.Pins = I2C_SCL_GPIO_PIN;
    GPIO_Init(I2C_SCL_GPIO_PORT, &GPIO_InitStructure);
    GPIO_InitStructure.Pins = I2C_SDA_GPIO_PIN;
    GPIO_Init(I2C_SDA_GPIO_PORT, &GPIO_InitStructure);

    I2C_Master_Init(I2C_PORT, &I2C_InitStructure);
